 ...
 */
final class Version20200427130451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, security_user_id INT NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_7CC7DA2CCA85D888 (security_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
